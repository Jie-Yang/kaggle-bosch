...
while True:
    try:
        for col_name in cols_numeric:
            ...
            file_path = 'model_stats/num/'+col_name+'.pkl'
            if os.path.exists(file_path):
                ...
                chunks = pd.read_csv('data/train_numeric.csv',usecols=[col_name],chunksize=max_chunk_size, low_memory=False,iterator=True)
